...
namespace SmartParking.ViewModels
{
    ...
    public class LocationPageViewModel : BaseViewModel
    {
        ...
        private static LocationPageViewModel locationDeniedPageViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="LocationPageViewModel" /> class.
        /// </summary>
        ...
        /// </summary>
        public static LocationPageViewModel BindingContext =>
            locationDeniedPageViewModel = PopulateData<LocationPageViewModel>("errorAndEmpty.json");
        ...
        {
            var file = "SmartParking.Data." + fileName;
